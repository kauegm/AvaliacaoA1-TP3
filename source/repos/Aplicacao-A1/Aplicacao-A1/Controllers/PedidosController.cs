...
namespace Aplicacao_A1.Controllers
{
    ...
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,DataPedido,Total")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,DataPedido,Total")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
